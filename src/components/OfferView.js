  ...
  return (
    <Hoc>
      ...
      <LoginInfoModal
        ...
        text={
          <h2>
            Aby wysłać wiadomość <a href="/login">zaloguj się</a>.
          </h2>
        }
      ></LoginInfoModal>
      <Modal open={props.isOpen} onClose={props.onRequestClose}>
        {props.offer && userName ? (
          <Hoc>
            ...
            <Modal.Actions>
              <div className="offer_view-actions">
                {!props.favourites && props.offer.id ? (
                  <span className="offer_view-actions-btn">
                    <Button
                      onClick={() => {
                        addToFavourites(props.offer.id);
                      }}
                      color="red"
                      animated
                    >
