...
export const fetchOffers = (
  ...
  API_Handler(false, {
    method: 'get',
    url: `joboffers/?limit=4&offset=0&search=${search}&ordering=${ordering}&min_salary_f=${min_salary}&city_id=${city_id}&category_id=${category_id}&user_id=${user_id}&remote=${remote}`,
  })
    .then((res) => {
